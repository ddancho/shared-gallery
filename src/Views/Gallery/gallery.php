  ...
  <ul class="nav__list">
    <li class="nav__listitem nav__listitem-active">
      <a
        ...
        action="<?php echo Application::$base; ?>/public"
      >
    ...
    <li class="nav__listitem">
      <a
        id="private"
        href="javascript:void(0)"
        action="<?php echo Application::$base; ?>/private"
      >
        <svg viewBox="0 0 24 24" fill="black" width="48px" height="48px">
          <path d="M0 0h24v24H0z" fill="none" />
          <path
...
<script defer src="<?php echo Application::$js; ?>/gallery/gallery.js" type="text/javascript"></script>
